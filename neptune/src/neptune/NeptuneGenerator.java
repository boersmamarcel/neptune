// $ANTLR 3.5.2 antlr/NeptuneGenerator.g 2014-06-30 01:36:18
...
public class NeptuneGenerator extends TreeParser {
	...
	public final Type print_statement() throws RecognitionException {
		...
		try {
			...
			// antlr/NeptuneGenerator.g:131:4: ( COMMA expression )*
			loop6:
			while (true) {
				int alt6=2;
				...
				switch (alt6) {
				case 1 :
					// antlr/NeptuneGenerator.g:131:5: COMMA expression
					{
	...
	// antlr/NeptuneGenerator.g:139:1: read_statement returns [Type type = null] : ^( READ (t= IDENTIFIER ) ( COMMA IDENTIFIER )* ) ;
	public final Type read_statement() throws RecognitionException {
		...
		boolean one=true;
		try {
			// antlr/NeptuneGenerator.g:141:2: ( ^( READ (t= IDENTIFIER ) ( COMMA IDENTIFIER )* ) )
			// antlr/NeptuneGenerator.g:141:4: ^( READ (t= IDENTIFIER ) ( COMMA IDENTIFIER )* )
			{
			match(input,READ,FOLLOW_READ_in_read_statement331); 
			match(input, Token.DOWN, null); 
			// antlr/NeptuneGenerator.g:141:11: (t= IDENTIFIER )
			// antlr/NeptuneGenerator.g:141:12: t= IDENTIFIER
			{
			t=(CommonTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_read_statement336); 
			}

			// antlr/NeptuneGenerator.g:141:26: ( COMMA IDENTIFIER )*
			loop7:
			while (true) {
				int alt7=2;
				...
				switch (alt7) {
				case 1 :
					// antlr/NeptuneGenerator.g:141:27: COMMA IDENTIFIER
					{
	...
	// antlr/NeptuneGenerator.g:149:1: declaration : ( ^( VAR t= type x= IDENTIFIER ( BECOMES expression )? ) | ^( CONST t= type x= IDENTIFIER BECOMES expression ) );
	public final void declaration() throws RecognitionException {
		CommonTree x=null;
		Type t =null;

		try {
			// antlr/NeptuneGenerator.g:150:2: ( ^( VAR t= type x= IDENTIFIER ( BECOMES expression )? ) | ^( CONST t= type x= IDENTIFIER BECOMES expression ) )
			int alt9=2;
			...
			switch (alt9) {
				case 1 :
					// antlr/NeptuneGenerator.g:150:4: ^( VAR t= type x= IDENTIFIER ( BECOMES expression )? )
					{
					...
					// antlr/NeptuneGenerator.g:150:55: ( BECOMES expression )?
					int alt8=2;
					...
					switch (alt8) {
						case 1 :
							// antlr/NeptuneGenerator.g:150:56: BECOMES expression
							{
					...
					break;
				case 2 :
					// antlr/NeptuneGenerator.g:161:4: ^( CONST t= type x= IDENTIFIER BECOMES expression )
					{
	...
	// antlr/NeptuneGenerator.g:167:1: expression returns [Type type = null] : t= assignment_expr ;
	public final Type expression() throws RecognitionException {
		...
		try {
			// antlr/NeptuneGenerator.g:168:2: (t= assignment_expr )
			// antlr/NeptuneGenerator.g:168:4: t= assignment_expr
			{
	...
	// antlr/NeptuneGenerator.g:171:1: assignment_expr returns [Type type = null] : (t= and_or_expr | ^( BECOMES x= IDENTIFIER ( ^( ARRAY_DEF n= NUMBER ) )? expression ) );
	public final Type assignment_expr() throws RecognitionException {
		...
		try {
			// antlr/NeptuneGenerator.g:172:2: (t= and_or_expr | ^( BECOMES x= IDENTIFIER ( ^( ARRAY_DEF n= NUMBER ) )? expression ) )
			int alt11=2;
			...
			switch (alt11) {
				case 1 :
					// antlr/NeptuneGenerator.g:172:4: t= and_or_expr
					{
					...
					break;
				case 2 :
					// antlr/NeptuneGenerator.g:173:4: ^( BECOMES x= IDENTIFIER ( ^( ARRAY_DEF n= NUMBER ) )? expression )
					{
					 int index = -1; 
					...
					// antlr/NeptuneGenerator.g:173:46: ( ^( ARRAY_DEF n= NUMBER ) )?
					int alt10=2;
					...
					switch (alt10) {
						case 1 :
							// antlr/NeptuneGenerator.g:173:47: ^( ARRAY_DEF n= NUMBER )
							{
	...
	// antlr/NeptuneGenerator.g:190:1: and_or_expr returns [Type type = null] : (t= boolean_expr | ^( AND expression expression ) | ^( OR expression expression ) );
	public final Type and_or_expr() throws RecognitionException {
		...
		try {
			// antlr/NeptuneGenerator.g:191:2: (t= boolean_expr | ^( AND expression expression ) | ^( OR expression expression ) )
			int alt12=3;
			switch ( input.LA(1) ) {
			case ARRAY_SET:
			case BLOCK:
			...
			switch (alt12) {
				case 1 :
					// antlr/NeptuneGenerator.g:191:4: t= boolean_expr
					{
					...
					break;
				case 2 :
					// antlr/NeptuneGenerator.g:192:4: ^( AND expression expression )
					{
					...
					break;
				case 3 :
					// antlr/NeptuneGenerator.g:196:4: ^( OR expression expression )
					{
	...
	// antlr/NeptuneGenerator.g:202:1: boolean_expr returns [Type type = null] : (t= plus_expr | ^( LT expression expression ) | ^( LT_EQ expression expression ) | ^( GT expression expression ) | ^( GT_EQ expression expression ) | ^( EQ expression expression ) | ^( NEQ expression expression ) );
	public final Type boolean_expr() throws RecognitionException {
		...
		try {
			// antlr/NeptuneGenerator.g:203:2: (t= plus_expr | ^( LT expression expression ) | ^( LT_EQ expression expression ) | ^( GT expression expression ) | ^( GT_EQ expression expression ) | ^( EQ expression expression ) | ^( NEQ expression expression ) )
			int alt13=7;
			switch ( input.LA(1) ) {
			case ARRAY_SET:
			case BLOCK:
			...
			switch (alt13) {
				case 1 :
					// antlr/NeptuneGenerator.g:203:4: t= plus_expr
					{
					...
					break;
				case 2 :
					// antlr/NeptuneGenerator.g:204:4: ^( LT expression expression )
					{
					...
					break;
				case 3 :
					// antlr/NeptuneGenerator.g:208:4: ^( LT_EQ expression expression )
					{
					...
					break;
				case 4 :
					// antlr/NeptuneGenerator.g:212:4: ^( GT expression expression )
					{
					...
					break;
				case 5 :
					// antlr/NeptuneGenerator.g:216:4: ^( GT_EQ expression expression )
					{
					...
					break;
				case 6 :
					// antlr/NeptuneGenerator.g:220:4: ^( EQ expression expression )
					{
					...
					break;
				case 7 :
					// antlr/NeptuneGenerator.g:224:4: ^( NEQ expression expression )
					{
	...
	// antlr/NeptuneGenerator.g:230:1: plus_expr returns [Type type = null] : (t= multi_expr | ^( PLUS expression expression ) | ^( MINUS expression expression ) );
	public final Type plus_expr() throws RecognitionException {
		...
		try {
			// antlr/NeptuneGenerator.g:231:2: (t= multi_expr | ^( PLUS expression expression ) | ^( MINUS expression expression ) )
			int alt14=3;
			switch ( input.LA(1) ) {
			case ARRAY_SET:
			case BLOCK:
			...
			switch (alt14) {
				case 1 :
					// antlr/NeptuneGenerator.g:231:4: t= multi_expr
					{
					...
					break;
				case 2 :
					// antlr/NeptuneGenerator.g:232:4: ^( PLUS expression expression )
					{
					...
					break;
				case 3 :
					// antlr/NeptuneGenerator.g:236:4: ^( MINUS expression expression )
					{
	...
	// antlr/NeptuneGenerator.g:242:1: multi_expr returns [Type type = null] : (t= operand | ^( TIMES expression expression ) | ^( DIVIDE expression expression ) );
	public final Type multi_expr() throws RecognitionException {
		...
		try {
			// antlr/NeptuneGenerator.g:243:2: (t= operand | ^( TIMES expression expression ) | ^( DIVIDE expression expression ) )
			int alt15=3;
			switch ( input.LA(1) ) {
			case ARRAY_SET:
			case BLOCK:
			...
			switch (alt15) {
				case 1 :
					// antlr/NeptuneGenerator.g:243:4: t= operand
					{
					...
					break;
				case 2 :
					// antlr/NeptuneGenerator.g:244:4: ^( TIMES expression expression )
					{
					...
					break;
				case 3 :
					// antlr/NeptuneGenerator.g:248:4: ^( DIVIDE expression expression )
					{
	...
	// $ANTLR start "operand"
	// antlr/NeptuneGenerator.g:254:1: operand returns [Type type=null] : (x= IDENTIFIER ( ^( ARRAY_DEF n= NUMBER ) )? |n= NUMBER | ^( ARRAY_SET (t= expression )+ ) | TRUE | FALSE |c= CHAR_LITERAL |s= STRING_LITERAL |t= codeblock |t= print_statement |t= read_statement );
	public final Type operand() throws RecognitionException {
		...
		try {
			// antlr/NeptuneGenerator.g:255:2: (x= IDENTIFIER ( ^( ARRAY_DEF n= NUMBER ) )? |n= NUMBER | ^( ARRAY_SET (t= expression )+ ) | TRUE | FALSE |c= CHAR_LITERAL |s= STRING_LITERAL |t= codeblock |t= print_statement |t= read_statement )
			int alt18=10;
			switch ( input.LA(1) ) {
			case IDENTIFIER:
				{
			...
			switch (alt18) {
				case 1 :
					// antlr/NeptuneGenerator.g:255:4: x= IDENTIFIER ( ^( ARRAY_DEF n= NUMBER ) )?
					{
					 int index = -1; 
					x=(CommonTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_operand771); 
					// antlr/NeptuneGenerator.g:255:37: ( ^( ARRAY_DEF n= NUMBER ) )?
					int alt16=2;
					...
					switch (alt16) {
						case 1 :
							// antlr/NeptuneGenerator.g:255:38: ^( ARRAY_DEF n= NUMBER )
							{
					...
					break;
				case 2 :
					// antlr/NeptuneGenerator.g:277:4: n= NUMBER
					{
					...
					break;
				case 3 :
					// antlr/NeptuneGenerator.g:281:4: ^( ARRAY_SET (t= expression )+ )
					{
					match(input,ARRAY_SET,FOLLOW_ARRAY_SET_in_operand807); 
					match(input, Token.DOWN, null); 
					// antlr/NeptuneGenerator.g:281:16: (t= expression )+
					int cnt17=0;
					loop17:
					while (true) {
						int alt17=2;
						...
						switch (alt17) {
						case 1 :
							// antlr/NeptuneGenerator.g:281:17: t= expression
							{
					...
					break;
				case 4 :
					// antlr/NeptuneGenerator.g:284:4: TRUE
					{
					match(input,TRUE,FOLLOW_TRUE_in_operand823); 
					...
					break;
				case 5 :
					// antlr/NeptuneGenerator.g:288:4: FALSE
					{
					match(input,FALSE,FOLLOW_FALSE_in_operand837); 
					...
					break;
				case 6 :
					// antlr/NeptuneGenerator.g:292:4: c= CHAR_LITERAL
					{
					c=(CommonTree)match(input,CHAR_LITERAL,FOLLOW_CHAR_LITERAL_in_operand852); 
					...
					break;
				case 7 :
					// antlr/NeptuneGenerator.g:296:4: s= STRING_LITERAL
					{
					s=(CommonTree)match(input,STRING_LITERAL,FOLLOW_STRING_LITERAL_in_operand866); 
					...
					break;
				case 8 :
					// antlr/NeptuneGenerator.g:306:4: t= codeblock
					{
					pushFollow(FOLLOW_codeblock_in_operand878);
					t=codeblock();
					state._fsp--;
					...
					break;
				case 9 :
					// antlr/NeptuneGenerator.g:307:4: t= print_statement
					{
					pushFollow(FOLLOW_print_statement_in_operand897);
					t=print_statement();
					state._fsp--;
					...
					break;
				case 10 :
					// antlr/NeptuneGenerator.g:308:4: t= read_statement
					{
					pushFollow(FOLLOW_read_statement_in_operand909);
					t=read_statement();
					state._fsp--;
	...
	// $ANTLR start "type"
	// antlr/NeptuneGenerator.g:311:1: type returns [Type type = null] : ( INTEGER (count= array_def )? | CHAR (count= array_def )? | BOOLEAN (count= array_def )? );
	public final Type type() throws RecognitionException {
		...
		try {
			// antlr/NeptuneGenerator.g:312:2: ( INTEGER (count= array_def )? | CHAR (count= array_def )? | BOOLEAN (count= array_def )? )
			int alt22=3;
			switch ( input.LA(1) ) {
			case INTEGER:
				{
			...
			switch (alt22) {
				case 1 :
					// antlr/NeptuneGenerator.g:312:4: INTEGER (count= array_def )?
					{
					match(input,INTEGER,FOLLOW_INTEGER_in_type929); 
					// antlr/NeptuneGenerator.g:312:17: (count= array_def )?
					int alt19=2;
					...
					break;
				case 2 :
					// antlr/NeptuneGenerator.g:318:4: CHAR (count= array_def )?
					{
					match(input,CHAR,FOLLOW_CHAR_in_type941); 
					// antlr/NeptuneGenerator.g:318:14: (count= array_def )?
					int alt20=2;
					...
					switch (alt20) {
						case 1 :
							// antlr/NeptuneGenerator.g:318:14: count= array_def
							{
							pushFollow(FOLLOW_array_def_in_type945);
							count=array_def();
							state._fsp--;
					...
					break;
				case 3 :
					// antlr/NeptuneGenerator.g:324:4: BOOLEAN (count= array_def )?
					{
					match(input,BOOLEAN,FOLLOW_BOOLEAN_in_type953); 
					// antlr/NeptuneGenerator.g:324:17: (count= array_def )?
					int alt21=2;
					...
					switch (alt21) {
						case 1 :
							// antlr/NeptuneGenerator.g:324:17: count= array_def
							{
							pushFollow(FOLLOW_array_def_in_type957);
							count=array_def();
							state._fsp--;
	...
	// antlr/NeptuneGenerator.g:332:1: array_def returns [int count = 0] : ^( ARRAY_DEF x= NUMBER ) ;
	public final int array_def() throws RecognitionException {
		...
		try {
			// antlr/NeptuneGenerator.g:333:2: ( ^( ARRAY_DEF x= NUMBER ) )
			// antlr/NeptuneGenerator.g:333:4: ^( ARRAY_DEF x= NUMBER )
			{
			match(input,ARRAY_DEF,FOLLOW_ARRAY_DEF_in_array_def976); 
			match(input, Token.DOWN, null); 
			x=(CommonTree)match(input,NUMBER,FOLLOW_NUMBER_in_array_def980); 
	...
	public static final BitSet FOLLOW_TRUE_in_operand823 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_FALSE_in_operand837 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CHAR_LITERAL_in_operand852 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_STRING_LITERAL_in_operand866 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_codeblock_in_operand878 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_print_statement_in_operand897 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_read_statement_in_operand909 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INTEGER_in_type929 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_array_def_in_type933 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CHAR_in_type941 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_array_def_in_type945 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_BOOLEAN_in_type953 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_array_def_in_type957 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ARRAY_DEF_in_array_def976 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_NUMBER_in_array_def980 = new BitSet(new long[]{0x0000000000000008L});
}
